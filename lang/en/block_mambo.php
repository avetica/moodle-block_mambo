...
$string['btn:setup'] = 'Course Mapping';
$string['heading:mambo_points'] = 'Mambo Points';
$string['heading:mambo_activities'] = 'Activities';
$string['activitiespage'] = 'List of activities';
$string['desc:mambo_points'] = 'You can drag-and-drop activities from the left and place them in a mambo point';
